...
public class TelaClienteController implements Initializable {
    ...
    void selecionarCliente(MouseEvent event) {
        if (event.getClickCount() == 2 && !lvCliente.getItems().isEmpty()) {
            novoCliente = false;

            c = lvCliente.getSelectionModel().getSelectedItem();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            lvCliente.getItems().addAll(ClienteDAO.retreaveAll());
