...
public class ClienteEnderecoDAO {
    ...
    public static ArrayList<Endereco> retreaveAll() throws SQLException {
        ...
        ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM cliente_endereco ORDER BY estado, cidade");
    ...
    public static ArrayList<Endereco> retreaveAll(int fk) throws SQLException {
        ...
        //faz de conta que é uma tabela na sua cabeça
        ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM cliente_endereco where fk_cliente=" + fk + " order by pk_endereco");
    ...
    public static void delete(int pk) throws SQLException {
        Connection conn = BancoDados.createConnection();
        conn.createStatement().execute("DELETE FROM cliente_endereco WHERE pk_endereco = " + pk);
    }

    public static void deleteAll(int fk) throws SQLException {
        Connection conn = BancoDados.createConnection();
        conn.createStatement().execute("DELETE FROM cliente_endereco WHERE fk_cliente = " + fk);
    }
}
